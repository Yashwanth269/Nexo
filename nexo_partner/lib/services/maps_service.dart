...
class MapsService {
  ...
  static Future<Map<String, dynamic>?> getDirections({
    ...
    try {
      debugPrint("📡 [ROUTE_FETCH_STARTED] origin: ${origin.latitude},${origin.longitude} -> dest: ${destination.latitude},${destination.longitude}");
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'OK') {
          ...
          debugPrint("✅ [ROUTE_FETCH_SUCCESS] Distance: $distance, Duration: $duration");
          ...
          debugPrint("❌ [ROUTE_FETCH_ERROR] Status: ${data['status']}");
        }
      }
    } catch (e) {
      debugPrint("❌ [ROUTE_FETCH_ERROR] Exception: $e");
    }
    return null;
  }
