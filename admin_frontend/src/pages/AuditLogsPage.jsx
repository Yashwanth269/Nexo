...
export const AuditLogsPage = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <div>
        <h1 style={{ fontSize: '24px', fontWeight: '800', color: 'var(--text-main)' }}>Audit Logs & System Health</h1>
        ...
        <table className="data-table">
          ...
          <tbody>
            <tr>
              ...
              <td style={{ fontWeight: '600', color: 'var(--text-main)' }}>categories_refactor_3tier</td>
            ...
            <tr>
              ...
              <td style={{ fontWeight: '600', color: 'var(--text-main)' }}>team_jobs_and_daily_progress</td>
              <td style={{ fontFamily: 'monospace', color: 'var(--text-muted)' }}>b9a8c7d6e5f4...</td>
              <td><span className="badge badge-green"><CheckCircle size={12} /> APPLIED</span></td>
            </tr>
            <tr>
              <td style={{ fontWeight: '700', color: '#60a5fa' }}>v22</td>
              <td style={{ fontWeight: '600', color: 'var(--text-main)' }}>ml_training_data_extension</td>
