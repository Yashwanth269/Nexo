...
const TRANSITIONS = {
    ...
    [STATES.WORKER_ASSIGNED]: [STATES.WORKER_CONFIRMED, STATES.WORKER_EN_ROUTE, STATES.WORKER_ARRIVED, STATES.SERVICE_IN_PROGRESS, STATES.CANCELLED],
    [STATES.WORKER_CONFIRMED]: [STATES.WORKER_EN_ROUTE, STATES.WORKER_ARRIVED, STATES.SERVICE_IN_PROGRESS, STATES.CANCELLED],
    [STATES.WORKER_EN_ROUTE]: [STATES.WORKER_ARRIVED, STATES.FORCE_ARRIVAL_PENDING_CONFIRMATION, STATES.SERVICE_STARTED, STATES.SERVICE_IN_PROGRESS, STATES.CANCELLED],
    [STATES.FORCE_ARRIVAL_PENDING_CONFIRMATION]: [STATES.WORKER_ARRIVED, STATES.SERVICE_STARTED, STATES.SERVICE_IN_PROGRESS, STATES.CANCELLED],
    [STATES.WORKER_ARRIVED]: [STATES.OTP_VERIFIED, STATES.SERVICE_STARTED, STATES.SERVICE_IN_PROGRESS, STATES.CANCELLED],
    [STATES.OTP_VERIFIED]: [STATES.SERVICE_STARTED, STATES.SERVICE_IN_PROGRESS, STATES.CANCELLED],
    [STATES.SERVICE_STARTED]: [STATES.SERVICE_IN_PROGRESS, STATES.SERVICE_COMPLETED, STATES.CANCELLED],
    [STATES.SERVICE_IN_PROGRESS]: [STATES.SERVICE_PAUSED, STATES.SERVICE_COMPLETED, STATES.CANCELLED],
    [STATES.SERVICE_PAUSED]: [STATES.SERVICE_RESUMED, STATES.CANCELLED],
    [STATES.SERVICE_RESUMED]: [STATES.SERVICE_IN_PROGRESS, STATES.SERVICE_COMPLETED, STATES.CANCELLED],
