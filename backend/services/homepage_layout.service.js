            ...
            switch (sec.section_type) {
                ...
                case 'top_picks':
                    dataPayload = [
                        ...
                        { name: 'House Cleaning', category: 'Home Care', rating: 4.6, prosCount: '180+ pros', image: 'https://nexoassets.s3.ap-south-2.amazonaws.com/images/1:1/House%20Cleaning2.jpeg', action: 'OPEN_CATEGORY', payload: 'House Cleaning' },
